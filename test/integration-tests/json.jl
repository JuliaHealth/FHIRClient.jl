...
@testset "Raw JSON" begin
    ...
    json_responses_patient = [
        FHIRClient.request_json(client, "GET", patient_request),
        FHIRClient.request_json(client, "GET", patient_request; body = JSON3.read("{}")),
        FHIRClient.request_json(client, "GET", patient_request; query = Dict{String, String}()),
        FHIRClient.request_json(client, "GET", patient_request; body = JSON3.read("{}"), query = Dict{String, String}()),
    ]
